...
class NotificationsHelper(val context: Context) {
    ...
    private val NOTIFACTION_ID = 123
    ...
    fun createNotification(){
        ...
        val notofication = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .build()
        NotificationManagerCompat.from(context).notify(NOTIFACTION_ID, notofication)
